...
1$ FRANC = 1.09CHF / 0.7980 USD 21d ma / 0.08749 Kas 90d ma = 15,61 Kas  (September 17, 2025)   
1$ FRANC = 1.09CHF / 0.8036 USD 21d ma / 0.08802 Kas 90d ma = 15,41 Kas  (September  7, 2025)     
...
[See historic $Franc prices here.](https://github.com/Mambo-Token/Solidcoins/blob/main/historic/franc-prices-historic.md)
...
Sell price increases yearly 12%, monthly 1%.  
...
December 2024: 1 $Franc = 1.00 CHF   
January 2025:  1 $Franc = 1.01 CHF   
,,
July 2025:     1 $Franc = 1.07 CHF  
....   
...
Whether the this price can be maintained or not, depends on the free market price of $Franc and the market price of the collateral of $Franc:  
...
But you can expect Franc to trade in a range of 0-20% deviation from the sells price. Since there is almost endless supply, the price will rather not go above the sells price, or only in low liquidity spikes. But it can easily fall below the current sales price and remain below for longer time, in a range of up to 20% - 30% lower.
...
The fact that the sales price get up 1% monthly helps keeping the value of $Franc moving upwards.  
The goal is to beat the creeping inflation.  
...
It was like the european crypto regulators read our 2021 "stablecoin" concept and adapted and implemented rules on June 2024 to ever prevent any entity in EU to launch a stablecoin without them having control over it.  
